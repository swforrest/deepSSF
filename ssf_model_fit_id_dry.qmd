...
if(file.exists(paste0("ssf_coefficients/model_id", focal_id, "_0p_harms_dry.rds"))) {
  ...
  # save model object
  saveRDS(model_0p_harms, file = paste0("ssf_coefficients/model_id", focal_id, "_0p_harms_dry.rds"))
...
if(file.exists(paste0("ssf_coefficients/model_id", focal_id, "_1p_harms_dry.rds"))) {
  ...
  # save model object
  saveRDS(model_1p_harms, file = paste0("ssf_coefficients/model_id", focal_id, "_1p_harms_dry.rds"))
...
if(file.exists(paste0("ssf_coefficients/model_id", focal_id, "_2p_harms_dry.rds"))) {
  ...
  # save model object
  saveRDS(model_2p_harms, file = paste0("ssf_coefficients/model_id", focal_id, "_2p_harms_dry.rds"))
...
if(file.exists(paste0("ssf_coefficients/model_id", focal_id, "_3p_harms_dry.rds"))) {
  ...
  # save model object
  saveRDS(model_3p_harms, file = paste0("ssf_coefficients/model_id", focal_id, "_3p_harms_dry.rds"))
