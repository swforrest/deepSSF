...
## Late dry season NDVI for simulations 

This is the same as in , for comparison

```{r}

plot(ndvi_projected[[8]])
ndvi_projected[[8]] |> writeRaster("mapping/cropped rasters/ndvi_aug_2018.tif", overwrite = T)
plot(ndvi_projected[[14]])
ndvi_projected[[14]] |> writeRaster("mapping/cropped rasters/ndvi_feb_2019.tif", overwrite = T)
