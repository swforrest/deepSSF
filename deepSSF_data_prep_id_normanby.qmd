...
buffalo <- read_csv("data/SpaceCows/Normanby_processed.csv")
...
ggsave("outputs/data_prep/buffalo_normanby_map.png", 
...
ggsave("outputs/data_prep/buffalo_normanby_timeline.png", 
...
ggsave("outputs/data_prep/buffalo_normanby_daily_locations.png",
...
buffalo_all_steps %>% write_csv(paste0("data/buffalo_normanby_all_steps_nxn", nxn_cells,".csv"))
