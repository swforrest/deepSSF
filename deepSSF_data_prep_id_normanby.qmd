...
mimal_extent <- create_rectangle_shapefile(
  ...
  output_path = "mapping/normanby_extent" # without extension
)
...
# read in the DEM
dem <- terra::rast("mapping/cropped rasters/DEM_H_normanby.tif") # hydro-enforced DEM
dem
plot(dem)
...
s2 <- terra::rast("mapping/cropped rasters/sentinel2/25m/normanby/S2_SR_masked_normanby_2023_08.tif")
plot(s2[[1]])
...
terra::writeRaster(dem, "mapping/cropped rasters/DEM_normanby_reprojected.tif", overwrite = T)
...
# save the layers
terra::writeRaster(slope, "mapping/cropped rasters/slope_normanby.tif", overwrite = T)
terra::writeRaster(roughness, "mapping/cropped rasters/roughness_normanby.tif", overwrite = T)
