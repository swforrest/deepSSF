...
hypertuning_csvs <- c(
  "Python/outputs/model_training/id2005_small_1_2025-04-14/deepSSF_id2005_n10103_2025-04-14.csv",
  "Python/outputs/model_training/id2005_med_4_2025-04-14/deepSSF_id2005_n10103_2025-04-14.csv",
  "Python/outputs/model_training/id2005_large_2_2025-04-14/deepSSF_id2005_n10103_2025-04-14.csv",
  "Python/outputs/model_training/id2005_large2_1_2025-04-14/deepSSF_id2005_n10103_2025-04-14.csv"
)
...
ggplot() +
  ...
  ggtitle("Habitat selection probability") +
  theme_bw() +
...
Plotting the habitat selection probabilities that have been scaled by their standard deviation.
...
ggsave(paste0("outputs/hyper-tuning/deepSSF_hyper-tuning_habitat_scaled_sliding_", window_width, "days.png"),
       width = 150, height = 100, units = "mm", dpi = 600)
...
ggplot() +
  ...
  scale_y_continuous("Probability value") +
  scale_x_datetime("Date") +
  ggtitle("Movement probability") +
  theme_bw() +
  theme(legend.position = "bottom",
    axis.text.x = element_text(angle = 30, hjust = 1))

ggsave(paste0("outputs/hyper-tuning/deepSSF_hyper-tuning_movement_sliding_", window_width, "days.png"),
       width = 150, height = 100, units = "mm", dpi = 600)
...
ggplot() +
  ...
  scale_y_continuous("Probability value") +
  scale_x_datetime("Date") +
  ggtitle("Next-step probability") +
  theme_bw() +
  theme(legend.position = "bottom",
    axis.text.x = element_text(angle = 30, hjust = 1))

ggsave(paste0("outputs/hyper-tuning/deepSSF_hyper-tuning_next-step_sliding_", window_width, "days.png"),
       width = 150, height = 100, units = "mm", dpi = 600)
...
ggplot() +
  ...
  ggtitle("Hourly habitat selection probability") +
  theme_bw() +
  theme(legend.position = "bottom")

ggsave(paste0("outputs/hyper-tuning/deepSSF_hyper-tuning_habitat_hourly.png"),
       width = 150, height = 100, units = "mm", dpi = 600)
...
ggplot() +
  ...
  scale_y_continuous("Probability value") +
  scale_x_continuous("Hour", breaks = seq(0,24,6)) +
  ggtitle("Hourly habitat selection probability (scaled)") +
  theme_bw() +
  theme(legend.position = "bottom")

ggsave(paste0("outputs/hyper-tuning/deepSSF_hyper-tuning_habitat_scaled_hourly.png"),
       width = 150, height = 100, units = "mm", dpi = 600)
...
ggplot() +
  ...
  scale_y_continuous("Probability value") +
  scale_x_continuous("Hour", breaks = seq(0,24,6)) +
  ggtitle("Hourly movement probability") +
  theme_bw() +
  theme(legend.position = "bottom")

ggsave(paste0("outputs/hyper-tuning/deepSSF_hyper-tuning_movement_hourly.png"),
       width = 150, height = 100, units = "mm", dpi = 600)
...
ggplot() +
  ...
  scale_y_continuous("Probability value") +
  scale_x_continuous("Hour", breaks = seq(0,24,6)) +
  ggtitle("Hourly next-step probability") +
  theme_bw() +
  theme(legend.position = "bottom")

ggsave(paste0("outputs/hyper-tuning/deepSSF_hyper-tuning_next-step_hourly.png"),
       width = 150, height = 100, units = "mm", dpi = 600)
