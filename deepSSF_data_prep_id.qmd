...
# convert to sf object and transform to the same projection as the covariates (GDA94 / Geoscience Australia Lambert, EPSG:3112)
...
buffer_distance <- 2500 # add a generous buffer distance to ensure we capture all steps for this ID
