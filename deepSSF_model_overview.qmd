...
![The bearing of hte previous step is added to the $\mu$ parameters of the turning angle distributions, as we are just estimating the deviation from the current bearing. This previous bearing is shown in the movement probability surface with the black arrow and the $\theta$ symobol.](figures/model_diagram_move.png)
