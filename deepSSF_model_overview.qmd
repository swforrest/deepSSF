...
Essentially, we have some set of covariates, which for the deepSSF case we need to crop out '**local**' layers that are 101 x 101 cells (at 25 m each), which cover around 97% of the observed step lengths.
