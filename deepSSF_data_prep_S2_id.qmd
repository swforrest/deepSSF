---
title: "Preparing data for deepSSF model fitting"
subtitle: "Using Sentinel-2 layers"
...
editor:
  source
abstract: |
  This document outlines the steps taken to prepare the data for the deepSSF model fitting, using Sentinel-2 data directly 
  (instead of derived covariates such as NDVI).
---
