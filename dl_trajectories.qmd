...
sim_data_full_list <- 
  list.files("Python/outputs/dl_trajectories/id2158_ta_mix_vm_mu_0-pi/", pattern = "*.csv", full.names = T)
...
ggplot() +
  geom_point(data = buffalo_all |> filter(id == 2158),
