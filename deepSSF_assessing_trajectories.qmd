...
sim_data_full_list <- 
  list.files("Python/outputs/model_training/id2005_scalar_movement_norm_4_2025-05-08/simulations/deepSSF_trajectories/", pattern = "*.csv", full.names = T)[1:50]

# to filter filenames with any string matching conditions
sim_data_filenames <- grep("3000steps", sim_data_full_list, value = T) #%>% 
...
ggsave(paste0("outputs/simulated_trajectories.png"), width=150, height=150, units="mm", dpi = 600)
...
ggsave(paste0("outputs/hourly_summaries_step.png"), width=180, height=150, units="mm", dpi = 600)
