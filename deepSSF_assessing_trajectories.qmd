...
sim_data_full_list <- 
  list.files("Python/outputs/model_training/id2005_med_cartesian_movement_6_2025-05-04/simulations/deepSSF_trajectories/", pattern = "*.csv", full.names = T)

# to filter filenames with any string matching conditions
sim_data_filenames <- grep("1000steps", sim_data_full_list, value = T) #%>% 
...
ggplot() +
  ...
  geom_path(data = all_data %>% filter(id %in% 1:50),
