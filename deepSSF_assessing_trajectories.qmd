...
sim_data_full_list <- 
  list.files("Python/outputs/model_training/id2005_med_2_2025-04-23/simulations/deepSSF_trajectories/2005/", pattern = "*.csv", full.names = T)

# to filter filenames with any string matching conditions
sim_data_filenames <- grep("2025-04-23", sim_data_full_list, value = T) #%>% 
...
ggplot() +
  ...
  geom_path(data = all_data %>% filter(id %in% 1:10),
