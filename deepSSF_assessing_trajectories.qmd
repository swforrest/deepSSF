...
sim_data_full_list <- 
  list.files("Python/outputs/model_training/id2005_polar_fcn_mixture_1_2025-04-28/simulations/deepSSF_trajectories/2005/", pattern = "*.csv", full.names = T)

# to filter filenames with any string matching conditions
sim_data_filenames <- grep("2025-04-28", sim_data_full_list, value = T) #%>% 
