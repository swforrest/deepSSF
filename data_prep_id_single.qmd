...
plot(ndvi_projected_norm)
plot(slope_norm, colNA='red')
plot(veg_herby_norm)
plot(canopy_cover_norm)

terra::global(ndvi_projected_norm, fun = "isNA")
terra::global(slope_norm, fun = "isNA")
terra::global(veg_herby_norm, fun = "isNA")
terra::global(canopy_cover_norm, fun = "isNA")

plot(is.na(slope_norm))
...
# buffalo_data <- buffalo_data %>% arrange(t_) |>  slice(1:5)
# buffalo_data <- buffalo_all |>  slice(1:1000)
