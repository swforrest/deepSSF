...
buffalo_data_covs <- buffalo_data %>% mutate(
  ...
  # )
    ...
    pres_filename = paste0("data_layers_single/pres/pres_id", id, "_index_", index, "_t2_", t2_date, "_hr_", hour_t2, ".tif"),
...
write_csv(buffalo_data_df, paste0("data_layers_single/all_buffalo", nxn_cells, "x", nxn_cells,
