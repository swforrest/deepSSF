...
subtitle: "Dynamic step selection functions with temporal harmonics"
...
abstract: |
  ...
  Here we fit SSF models with and without temporal harmonics to buffalo data, which is similar to the approach in @Forrest2024-g except that here we
  ...
  [SSF Validation](next_step_validation.qmd) script, and compare these to the next-step predictions of the deepSSF models.
---
