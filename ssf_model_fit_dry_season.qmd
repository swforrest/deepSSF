---
title: "Fitting SSF models to the buffalo data"
...
buffalo_data <- buffalo_data_all %>% filter(id == 2005 & month %in% months_wet) # dry season
...
if(file.exists("ssf_coefficients/model_twostep_0p_harms_dry.rds")) {
  
  model_twostep_0p_harms <- readRDS("ssf_coefficients/model_twostep_0p_harms_dry.rds")
  print("Read existing model")
  
} else {
  
  tic()
    model_twostep_0p_harms <- fit_clogit(formula = formula_twostep_0p,
                                         data = buffalo_data_scaled_0p)
  toc()
  
  # save model object
  saveRDS(model_twostep_0p_harms, file = "ssf_coefficients/model_twostep_0p_harms_dry.rds")
...
if(file.exists("ssf_coefficients/model_twostep_1p_harms_dry.rds")) {
  
  model_twostep_1p_harms <- readRDS("ssf_coefficients/model_twostep_1p_harms_dry.rds")
  print("Read existing model")
  
} else {

  tic()
  model_twostep_1p_harms <- fit_clogit(formula = formula_twostep_1p,
                                       data = buffalo_data_scaled_1p)
  toc()
  
  # save model object
  saveRDS(model_twostep_1p_harms, file = "ssf_coefficients/model_twostep_1p_harms_dry.rds")
...
if(file.exists("ssf_coefficients/model_twostep_2p_harms_dry.rds")) {
  
  model_twostep_2p_harms <- readRDS("ssf_coefficients/model_twostep_2p_harms_dry.rds")
  print("Read existing model")
  
} else {

  tic()
  model_twostep_2p_harms <- fit_clogit(formula = formula_twostep_2p,
           data = buffalo_data_scaled_2p)
  toc()
  
  # save model object
  saveRDS(model_twostep_2p_harms, file = "ssf_coefficients/model_twostep_2p_harms_dry.rds")
...
if(file.exists("ssf_coefficients/model_twostep_3p_harms_dry.rds")) {
  
  model_twostep_3p_harms <- readRDS("ssf_coefficients/model_twostep_3p_harms_dry.rds")
  print("Read existing model")
  
} else {

  tic()
  model_twostep_3p_harms <- fit_clogit(formula = formula_twostep_3p,
                                     data = buffalo_data_scaled_3p)
  toc()
  
  # save model object
  saveRDS(model_twostep_3p_harms, file = "ssf_coefficients/model_twostep_3p_harms_dry.rds")
...
# model_twostep_0p_harms$model$coefficients
...
coefs_clr_0p <- data.frame(coefs = names(model_twostep_0p_harms$model$coefficients), 
                           value = model_twostep_0p_harms$model$coefficients)
...
# model_twostep_1p_harms
# model_twostep_1p_harms$model$coefficients
...
coefs_clr_1p <- data.frame(coefs = names(model_twostep_1p_harms$model$coefficients), 
                           value = model_twostep_1p_harms$model$coefficients)
...
# model_twostep_2p_harms
# model_twostep_2p_harms$model$coefficients
...
coefs_clr_2p <- data.frame(coefs = names(model_twostep_2p_harms$model$coefficients), 
                           value = model_twostep_2p_harms$model$coefficients)
...
# model_twostep_3p_harms$model$coefficients
...
coefs_clr_3p <- data.frame(coefs = names(model_twostep_3p_harms$model$coefficients), 
                           value = model_twostep_3p_harms$model$coefficients)
