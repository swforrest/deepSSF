...
walk(buffalo_data_covs$ndvi_local[1:n_plots], plot)
...
buffalo_data_covs <- buffalo_data_covs %>% filter(x2_cent > -1250 & x2_cent < 1250 & y2_cent > -1250 & y2_cent < 1250) %>% drop_na(ta)
buffalo_data_covs
...
#   writeRaster(paste0("buffalo_ndvi_local", raster_size, "_lag_", hourly_lag, "hr_n", n_samples, ".tif"), overwrite = T)
# rast(buffalo_data_covs$veg_herby_local) %>% 
#   writeRaster(paste0("buffalo_herby_local", raster_size, "_lag_", hourly_lag, "hr_n", n_samples, ".tif"), overwrite = T)
# rast(buffalo_data_covs$canopy_cover_local) %>% 
#   writeRaster(paste0("buffalo_canopy_local", raster_size, "_lag_", hourly_lag, "hr_n", n_samples, ".tif"), overwrite = T)
# rast(buffalo_data_covs$slope_local) %>% 
#   writeRaster(paste0("buffalo_slope_local", raster_size, "_lag_", hourly_lag, "hr_n", n_samples, ".tif"), overwrite = T)
# rast(buffalo_data_covs$pres_local) %>% 
#   writeRaster(paste0("buffalo_pres_local", raster_size, "_lag_", hourly_lag, "hr_n", n_samples, ".tif"), overwrite = T)

rast(buffalo_data_covs$ndvi_cent) %>% 
  writeRaster(paste0("buffalo_ndvi_cent", raster_size, "_lag_", hourly_lag, "hr_n", n_samples, ".tif"), overwrite = T)
rast(buffalo_data_covs$veg_herby_cent) %>% 
  writeRaster(paste0("buffalo_herby_cent", raster_size, "_lag_", hourly_lag, "hr_n", n_samples, ".tif"), overwrite = T)
rast(buffalo_data_covs$canopy_cover_cent) %>% 
  writeRaster(paste0("buffalo_canopy_cent", raster_size, "_lag_", hourly_lag, "hr_n", n_samples, ".tif"), overwrite = T)
rast(buffalo_data_covs$slope_cent) %>% 
  writeRaster(paste0("buffalo_slope_cent", raster_size, "_lag_", hourly_lag, "hr_n", n_samples, ".tif"), overwrite = T)
rast(buffalo_data_covs$pres_cent) %>% 
  writeRaster(paste0("buffalo_pres_cent", raster_size, "_lag_", hourly_lag, "hr_n", n_samples, ".tif"), overwrite = T)
...
print(buffalo_data_covs %>% filter(hour_t2 == i) %>% ggplot() +
  geom_histogram(aes(x = sl), binwidth = 25))
}
