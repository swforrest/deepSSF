...
rast(buffalo_data_covs$ndvi_cent) %>% writeRaster(paste0("buffalo_ndvi_cent50x50_n", n_samples, ".tif"), overwrite = T)
rast(buffalo_data_covs$veg_herby_cent) %>% writeRaster(paste0("buffalo_herby_cent50x50_n", n_samples, ".tif"), overwrite = T)
rast(buffalo_data_covs$canopy_cover_cent) %>% writeRaster(paste0("buffalo_canopy_cent50x50_n", n_samples, ".tif"), overwrite = T)
rast(buffalo_data_covs$slope_cent) %>% writeRaster(paste0("buffalo_slope_cent50x50_n", n_samples, ".tif"), overwrite = T)
rast(buffalo_data_covs$pres) %>% writeRaster(paste0("buffalo_pres_cent50x50_n", n_samples, ".tif"), overwrite = T)
