...
buffer <- 2500
# subset the data
buffalo2005 <- buffalo_all %>% filter(id == "2005") %>% slice(1:10000)
...
walk(buffalo2005_covs$ndvi_cent[1:10], plot)
walk(buffalo2005_covs$veg_herby_cent[1:10], terra::plot)
walk(buffalo2005_covs$canopy_cover_cent[1:10], terra::plot)
walk(buffalo2005_covs$slope_cent[1:10], terra::plot)

walk(buffalo2005_covs$pres[1:10], terra::plot)
