...
library(tidyverse)
packages <- c("terra", "beepr", "tictoc", "viridis", "here")
...
base_dir <- here::here("Python/outputs/model_training/id2005_med_scalar_movement_8_2025-05-06/landscape_predictions")

# yday 45
habitat_selection_yday45 <- 
  read_csv(paste0(base_dir, "/yday45/id2005_hourly_habitat_suitability_landscape_subset_yday45.csv"))

# yday 225
habitat_selection_yday225 <- 
  read_csv("Python/outputs/model_training/id2005_med_scalar_movement_8_2025-05-06/landscape_predictions/yday225/id2005_hourly_habitat_suitability_landscape_subset_yday225.csv")
...
ggsave("Python/outputs/model_training/id2005_med_scalar_movement_8_2025-05-06/landscape_predictions/ndvi_habitat_selection_yday45_hour1.png", width = 150, height = 90, 
       units = "mm", dpi = 300)
...
ggsave("Python/outputs/model_training/id2005_med_scalar_movement_8_2025-05-06/landscape_predictions/ndvi_habitat_selection_yday45_hour7.png", width = 150, height = 90, 
       units = "mm", dpi = 300)
...
ggsave("Python/outputs/model_training/id2005_med_scalar_movement_8_2025-05-06/landscape_predictions/ndvi_habitat_selection_yday45_hour12.png", width = 150, height = 90, 
       units = "mm", dpi = 300)
...
ggsave("Python/outputs/model_training/id2005_med_scalar_movement_8_2025-05-06/landscape_predictions/ndvi_habitat_selection_yday45_all_hours.png", width = 150, height = 90, 
       units = "mm", dpi = 300)
...
# for manuscript
ggsave("Python/outputs/model_training/id2005_med_scalar_movement_8_2025-05-06/landscape_predictions/ndvi_habitat_selection_yday45.png", 
       width = 90, height = 75, 
       units = "mm", dpi = 600)

# for website
ggsave("Python/outputs/model_training/id2005_med_scalar_movement_8_2025-05-06/landscape_predictions/ndvi_habitat_selection_yday45_website.png", 
       width = 150, height = 90, 
       units = "mm", dpi = 300)
...
# for manuscript
ggsave("Python/outputs/model_training/id2005_med_scalar_movement_8_2025-05-06/landscape_predictions/ndvi_habitat_selection_yday225.png", 
       width = 90, height = 75, 
       units = "mm", dpi = 600)

# for website
ggsave("Python/outputs/model_training/id2005_med_scalar_movement_8_2025-05-06/landscape_predictions/ndvi_habitat_selection_yday225_website.png", 
       width = 150, height = 90, 
       units = "mm", dpi = 300)
...
ggplot(habitat_selection_yday45_long, 
       aes(x = Hour, y = as.factor(Canopy_cover))) +  
  stat_summary_2d(aes(z = Values), fun = mean, bins = c(23,15)) + 
  scale_fill_viridis_c("Mean probability") +  
  scale_x_continuous("Hour", breaks = seq(0,24,6)) +  
  scale_y_discrete("Canopy cover (%)") +
  ggtitle(paste0("Prediction values: Day 45")) +
  theme_bw() +
  theme(legend.position = "none")

ggsave("Python/outputs/model_training/id2005_med_scalar_movement_8_2025-05-06/landscape_predictions/canopy_habitat_selection_yday45.png", 
       width = 90, height = 75, 
       units = "mm", dpi = 600)
...
ggsave("Python/outputs/model_training/id2005_med_scalar_movement_8_2025-05-06/landscape_predictions/canopy_habitat_selection_yday225.png", width = 90, height = 75, 
       units = "mm", dpi = 600)
...
ggsave("Python/outputs/model_training/id2005_med_scalar_movement_8_2025-05-06/landscape_predictions/herby_habitat_selection_yday45.png", width = 90, height = 75, 
       units = "mm", dpi = 600)
...
ggsave("Python/outputs/model_training/id2005_med_scalar_movement_8_2025-05-06/landscape_predictions/herby_habitat_selection_yday225.png", width = 90, height = 75, 
       units = "mm", dpi = 600)
...
ggsave("Python/outputs/model_training/id2005_med_scalar_movement_8_2025-05-06/landscape_predictions/slope_habitat_selection_yday45.png", width = 90, height = 75, 
       units = "mm", dpi = 600)
...
ggsave("Python/outputs/model_training/id2005_med_scalar_movement_8_2025-05-06/landscape_predictions/slope_habitat_selection_yday225.png", width = 90, height = 75, 
       units = "mm", dpi = 600)
