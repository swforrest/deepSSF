...
buffalo_all_steps %>% write_csv("data/lakefield_steps.csv")
...
mimal_extent <- create_rectangle_shapefile(
  ...
  output_path = "mapping/lakefield_extent" # without extension
)
...
# read in the DEM
dem <- terra::rast("mapping/cropped rasters/DEM_H_lakefield.tif") # hydro-enforced DEM
dem
plot(dem)
...
s2 <- terra::rast("mapping/cropped rasters/sentinel2/25m/lakefield/S2_SR_masked_lakefield_2023_08.tif")
plot(s2[[1]])
...
terra::writeRaster(dem, "mapping/cropped rasters/DEM_lakefield_reprojected.tif", overwrite = T)
...
# save the layers
terra::writeRaster(slope, "mapping/cropped rasters/slope_lakefield.tif", overwrite = T)
terra::writeRaster(roughness, "mapping/cropped rasters/roughness_lakefield.tif", overwrite = T)
