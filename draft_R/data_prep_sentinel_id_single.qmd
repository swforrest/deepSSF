...
These have been normalised to a 0-1 scale. Check the 'covariate_preparation.qmd' script for details on how these were generated, and for the scaling factors.
...
s2_2019_01_norm <- rast("mapping/cropped rasters/sentinel2/25m/S2_SR_masked_scaled_25m_2019_01.tif")
s2_2019_02_norm <- rast("mapping/cropped rasters/sentinel2/25m/S2_SR_masked_scaled_25m_2019_02.tif")
s2_2019_03_norm <- rast("mapping/cropped rasters/sentinel2/25m/S2_SR_masked_scaled_25m_2019_03.tif")
s2_2019_04_norm <- rast("mapping/cropped rasters/sentinel2/25m/S2_SR_masked_scaled_25m_2019_04.tif")
s2_2019_05_norm <- rast("mapping/cropped rasters/sentinel2/25m/S2_SR_masked_scaled_25m_2019_05.tif")
s2_2019_06_norm <- rast("mapping/cropped rasters/sentinel2/25m/S2_SR_masked_scaled_25m_2019_06.tif")
s2_2019_07_norm <- rast("mapping/cropped rasters/sentinel2/25m/S2_SR_masked_scaled_25m_2019_07.tif")
s2_2019_08_norm <- rast("mapping/cropped rasters/sentinel2/25m/S2_SR_masked_scaled_25m_2019_08.tif")
s2_2019_09_norm <- rast("mapping/cropped rasters/sentinel2/25m/S2_SR_masked_scaled_25m_2019_09.tif")
s2_2019_10_norm <- rast("mapping/cropped rasters/sentinel2/25m/S2_SR_masked_scaled_25m_2019_10.tif")
s2_2019_11_norm <- rast("mapping/cropped rasters/sentinel2/25m/S2_SR_masked_scaled_25m_2019_11.tif")
s2_2019_12_norm <- rast("mapping/cropped rasters/sentinel2/25m/S2_SR_masked_scaled_25m_2019_12.tif")

s2_2019_01_norm

```

### Combine the monthly Sentinel 2 raster stacks into a list so they can be subsetted

```{r}

s2_list <- list(s2_2019_01_norm, s2_2019_02_norm, s2_2019_03_norm, 
                s2_2019_04_norm, s2_2019_05_norm, s2_2019_06_norm, 
                s2_2019_07_norm, s2_2019_08_norm, s2_2019_09_norm, 
                s2_2019_10_norm, s2_2019_11_norm, s2_2019_12_norm)
...
for(i in 1:length(buffalo_ids)) {
  ...
  buffalo_data_covs <- buffalo_data %>% mutate(
    ...
    y_max = y_ + buffer
      ...
      # Sentinel 2
      # index of the Sentinel 2 image closest to the time of the location, which is just the month
      s2_index = lubridate::month(t_),
      
      # Sentinel 2 - B1
      s2_b1_filename = paste0("data_layers_single/s2_b1/s2_b1_id", id, "_index_", index, "_t2_", t2_date, "_hr_", hour_t2, ".tif"),
      s2_b1_cent = list({
      ...
      # Save the s2_b1_cent raster and store the filename
      s2_b1_filename = save_raster(s2_b1_cent[[1]], s2_b1_filename),
      
      
      # Sentinel 2 - B2
      s2_b2_filename = paste0("data_layers_single/s2_b2/s2_b2_id", id, "_index_", index, "_t2_", t2_date, "_hr_", hour_t2, ".tif"),
      s2_b2_cent = list({
      ...
      # Save the s2_b2_cent raster and store the filename
      s2_b2_filename = save_raster(s2_b2_cent[[1]], s2_b2_filename),
      
      
      # Sentinel 2 - B3
      s2_b3_filename = paste0("data_layers_single/s2_b3/s2_b3_id", id, "_index_", index, "_t2_", t2_date, "_hr_", hour_t2, ".tif"),
      s2_b3_cent = list({
      ...
      # Save the s2_b3_cent raster and store the filename
      s2_b3_filename = save_raster(s2_b3_cent[[1]], s2_b3_filename),
      
      
      # Sentinel 2 - B4
      s2_b4_filename = paste0("data_layers_single/s2_b4/s2_b4_id", id, "_index_", index, "_t2_", t2_date, "_hr_", hour_t2, ".tif"),
      s2_b4_cent = list({
      ...
      # Save the s2_b4_cent raster and store the filename
      s2_b4_filename = save_raster(s2_b4_cent[[1]], s2_b4_filename),
      
      
      # Sentinel 2 - B5
      s2_b5_filename = paste0("data_layers_single/s2_b5/s2_b5_id", id, "_index_", index, "_t2_", t2_date, "_hr_", hour_t2, ".tif"),
      s2_b5_cent = list({
      ...
      # Save the s2_b5_cent raster and store the filename
      s2_b5_filename = save_raster(s2_b5_cent[[1]], s2_b5_filename),
      
      
      # Sentinel 2 - B6
      s2_b6_filename = paste0("data_layers_single/s2_b6/s2_b6_id", id, "_index_", index, "_t2_", t2_date, "_hr_", hour_t2, ".tif"),
      s2_b6_cent = list({
      ...
      # Save the s2_b6_cent raster and store the filename
      s2_b6_filename = save_raster(s2_b6_cent[[1]], s2_b6_filename),
      
      
      # Sentinel 2 - B7
      s2_b7_filename = paste0("data_layers_single/s2_b7/s2_b7_id", id, "_index_", index, "_t2_", t2_date, "_hr_", hour_t2, ".tif"),
      s2_b7_cent = list({
      ...
      # Save the s2_b7_cent raster and store the filename
      s2_b7_filename = save_raster(s2_b7_cent[[1]], s2_b7_filename),
      
      
      # Sentinel 2 - B8
      s2_b8_filename = paste0("data_layers_single/s2_b8/s2_b8_id", id, "_index_", index, "_t2_", t2_date, "_hr_", hour_t2, ".tif"),
      s2_b8_cent = list({
      ...
      # Save the s2_b8_cent raster and store the filename
      s2_b8_filename = save_raster(s2_b8_cent[[1]], s2_b8_filename),
      
      
      # Sentinel 2 - B8A
      s2_b8a_filename = paste0("data_layers_single/s2_b8a/s2_b8a_id", id, "_index_", index, "_t2_", t2_date, "_hr_", hour_t2, ".tif"),
      s2_b8a_cent = list({
      ...
      # Save the s2_b8a_cent raster and store the filename
      s2_b8a_filename = save_raster(s2_b8a_cent[[1]], s2_b8a_filename),
      
      
      # Sentinel 2 - B9
      s2_b9_filename = paste0("data_layers_single/s2_b9/s2_b9_id", id, "_index_", index, "_t2_", t2_date, "_hr_", hour_t2, ".tif"),
      s2_b9_cent = list({
      ...
      # Save the s2_b9_cent raster and store the filename
      s2_b9_filename = save_raster(s2_b9_cent[[1]], s2_b9_filename),
      
      
      # Sentinel 2 - B11
      s2_b11_filename = paste0("data_layers_single/s2_b11/s2_b11_id", id, "_index_", index, "_t2_", t2_date, "_hr_", hour_t2, ".tif"),
      s2_b11_cent = list({
      ...
      # Save the s2_b11_cent raster and store the filename
      s2_b11_filename = save_raster(s2_b11_cent[[1]], s2_b11_filename),
      
      
      # Sentinel 2 - B12
      s2_b12_filename = paste0("data_layers_single/s2_b12/s2_b12_id", id, "_index_", index, "_t2_", t2_date, "_hr_", hour_t2, ".tif"),
      s2_b12_cent = list({
      ...
      # Save the s2_b12_cent raster and store the filename
      s2_b12_filename = save_raster(s2_b12_cent[[1]], s2_b12_filename),
  ...
  write_csv(buffalo_data_df, paste0("data_layers_single/buffalo_S2_id", buffalo_ids[i], "_", nxn_cells, "x", nxn_cells,
...
buffalo_all_df <- bind_rows(list.files("data_layers_single", pattern = "S2_id", full.names = TRUE) %>% 
  map_dfr(read_csv))

n_samples <- nrow(buffalo_all_df)

# save as a new csv
write_csv(buffalo_all_df, paste0("data_layers_single/buffalo_S2_all_101x101_data_df_lag_1hr_n", n_samples,".csv"))
