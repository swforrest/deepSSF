...
if(file.exists(paste0("ssf_coefficients/model_id", focal_id, "_0p_harms_wet.rds"))) {
  
  model_0p_harms <- readRDS(paste0("ssf_coefficients/model_id", focal_id, "_0p_harms_wet.rds"))
  ...
  # save model object
  saveRDS(model_0p_harms, file = paste0("ssf_coefficients/model_id", focal_id, "_0p_harms_wet.rds"))
