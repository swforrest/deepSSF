...
class Params_to_Grid_Block(nn.Module):
    ...
    def forward(self, x, bearing):
        ...
        gamma_density_layer = gamma_density_layer1
        ...
        vonmises_kappa1 = torch.exp(x[:, 3]).unsqueeze(0).unsqueeze(0)
        ...
        vonmises_density_layer = vonmises_density_layer1
...
class Params_to_Density_Block(nn.Module):
    ...
    def forward(self, x, step_length, turn_angle, bearing):
        ...
        vonmises_density = vonmises_density1
