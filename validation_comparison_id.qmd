...
validation_ssf_move <- validation_ssf_all %>% 
  dplyr::select(id, x_, y_, t_, x2_, y2_, hour_t1, yday_t1, contains("prob_movement")) %>% 
...
validation_ssf_habitat <- validation_ssf_all %>% 
  dplyr::select(id, x_, y_, t_, x2_, y2_, hour_t1, yday_t1, contains("prob_habitat")) %>% 
...
validation_ssf_next_step <- validation_ssf_all %>% 
  dplyr::select(id, x_, y_, t_, x2_, y2_, hour_t1, yday_t1, contains("prob_next_step")) %>% 
...
validation_deepssf <- "Python/outputs/model_training/id2005_scalar_movement_ChV_1_2025-05-08/deepSSF_id2005_n10103.csv"
validation_ids <- 2005
...
validation_deepssf_long <- validation_deepssf_all %>% 
  dplyr::select(id, x_, y_, t_, x2_, y2_, hour_t1, yday_t1, contains("probs")) %>% 
